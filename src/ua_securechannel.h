...
/* Decrypt a chunk and add it to the message */
UA_StatusCode
...
/* Process received complete messages. The callback function is called with the
 * complete message body if the message is complete.
 *
